...
Epistemic Gap Mapper should be community-grown because no single actor can reliably identify all frame dependencies, hidden narratives, domain-specific overclaims, and cross-domain gaps.
...
- **Narrative Auditor**: decomposes standard narratives and traces their evidentiary basis.
...
7. Expert criticism should be node-specific whenever possible.
